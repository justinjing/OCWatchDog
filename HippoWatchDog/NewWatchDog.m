...
#import "NewWatchDog.h"
#import <CrashReporter/CrashReporter.h>

@interface NewWatchDog ()
{
    int timeoutCount;
...
@end
@implementation NewWatchDog

+ (instancetype)shareInstance {
    static dispatch_once_t onceToken;
    static NewWatchDog *tool = nil;
    dispatch_once(&onceToken, ^{
        tool = [[NewWatchDog alloc] init];
    });
    return tool;
}
...
{
    NewWatchDog *tool = (__bridge NewWatchDog *)info;
